...
function initTodo (){
  for (let i = 0; i < todoListItems.length; i++) {
    ...
    <input type="checkbox" name="milk" ${todoListItems[i].isChecked  "checked" : ""} id="todo_${
      todoListItems[i].todo}" />
      ...
      .addEventListener("click",function (e) {
        ...
        if (selectedItem.checked) {
          selectedItem.nextElementsSibling.classList.add("strike-off");
        } else {
          selectedItem.nextElementsSibling.classList.remove("strike-off")''
        }
